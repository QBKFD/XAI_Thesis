...
filepathX = 'https://raw.githubusercontent.com/wangtongada/BOA/master/tictactoe_X.txt' # input file X
filepathY = 'https://raw.githubusercontent.com/wangtongada/BOA/master/tictactoe_Y.txt'
#filepathY = '/Users/x/Desktop/Repositories/BOA-master/tictactoe_Y.txt'"
df = pd.read_csv(filepathX,header=0,sep=" ")
Y = pd.read_csv(filepathY, header=None, delimiter=" ")
